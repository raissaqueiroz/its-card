	            ...
	            <div class="col-md-8 col-sm-12 col-lg-5">
	                <div class="card">
	                	<div class="card-header text-center">
	                		<!--Logo-->
							<a class="navbar-brand mb-0" href="#"><h1 class="color-pantone">Entrar</h1></a>
	                	</div>
	                    <div class="card-body">
	                        <form action="gLogin.php" method="POST" autocomplete="off">
	                        	...
	                        	<div class="input-group mb-2">
							        ...
							        <button type="submit" id="sendlogin" class="btn btn-pantone ml-1 mt-3 mt-md-0 col-md-3" name="entrar">Entrar</button>
							    </div>
							    <div class="input-group d-flex justify-content-center">
							    	<small id="passwordHelpBlock" class="form-text text-muted">
									 	<a class="nav-link mt-3 color-pantone" href="cLogin.php" title="cadastre-se">Não possui um cadastro? Clique aqui!</a>
									</small>
							    </div>
